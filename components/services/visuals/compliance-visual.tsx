          ...
          <div key={i} className="relative w-full flex items-center justify-center">
            ...
            {i < 2 && (
              <div className="absolute top-full left-1/2 -translate-x-1/2 w-px h-6 bg-white/10 overflow-hidden">
                <motion.div
                  className="w-full h-full bg-[#c85a3a]"
                  initial={{ y: "-100%" }}
            ...
            >
              ...
              <motion.div
                className="absolute inset-0 bg-[#c85a3a]/20 mix-blend-overlay"
                initial={{ opacity: 0 }}
              ...
              {/* Checkmark update */}
              <motion.div
                className="absolute right-4 top-1/2 -translate-y-1/2 text-[#c85a3a]"
